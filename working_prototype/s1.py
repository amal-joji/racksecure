...
def match_faces(detected_descriptors, known_face_descriptors, threshold=100):  # Lower threshold for more matches
...
def main():
    ...
    # Open video stream
    cap = cv2.VideoCapture(r"C:\Users\saduv\Downloads\adhavan5.mp4")  # Provide your video file or 0 for webcam
    ...
    while True:
            ...
            if i in indexes:
                ...
                if descriptors is not None:
                    ...
                    if best_match_index != -1:
                        ...
                        print(f"Matched {label} with score {best_match_score}")
                    else:
                        # Draw rectangle for unknown face
                        cv2.rectangle(frame, (x, y), (x+w, y+h), (0, 255, 0), 2)  # Green rectangle for unknown face
        ...
        for label, (x, y, w, h) in matched_faces.items():
            cv2.rectangle(frame, (x, y), (x+w, y+h), (0, 255, 0), 2)  # Green rectangle for known face
